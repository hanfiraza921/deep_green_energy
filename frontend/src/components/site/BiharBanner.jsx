...
export const BiharBanner = ({ onAction }) => {
  ...
  return (
    <section
      ...
      className="relative py-12 lg:py-16 bg-blue-950 overflow-hidden"
    >
      {/* topographic pattern */}
      <div
        aria-hidden
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        ...
        >
          <div className="flex items-start gap-4 max-w-3xl">
            ...
            <div>
              <h3 className="font-heading text-2xl sm:text-3xl lg:text-4xl font-black tracking-tight text-white text-balance">
                {t("bihar.title")}
              </h3>
              <p className="mt-2 text-sm sm:text-base text-blue-200">
                {t("bihar.subtitle")} • Patna, Gaya, Bhagalpur, Muzaffarpur, Darbhanga, Purnia & 32 more.
              </p>
            </div>
          </div>
          <button
